...
vowels, much like Twitter was originally called twttr. In a file called twttr.py, implement a
program that prompts the user for a str of text and then outputs that same text but with all
...
def twttr():
    ...
    Returns:
        str: The modified string with the vowels removed.
    """
